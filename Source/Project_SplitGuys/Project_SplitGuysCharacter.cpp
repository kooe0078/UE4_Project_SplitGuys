...
void AProject_SplitGuysCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AProject_SplitGuysCharacter::OnResetVR);
}


void AProject_SplitGuysCharacter::OnResetVR()
{
	// If Project_SplitGuys is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Project_SplitGuys.Build.cs is not automatically propagated
